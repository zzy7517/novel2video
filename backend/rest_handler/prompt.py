...
from backend.util.constant import character_dir, novel_fragments_dir, prompts_dir, prompts_en_dir
...
3. 输出画面感强的动词，比如开车，不输出画面感不强的动词，比如嘲讽，如果人物有动作，则优先输出人物和动作
4. 不要输出形容词
...
13. 如果提取出来的这个词语在你看来无法使用图像表示，则换一个更容易使用画面表示的词语，可以根据上下文再发散
14. 如果某一行输入无法提取出内容，输出“无”，但不要不输出
...
13. 山崖之颠，萧炎斜躺在草地之上，嘴中叼中一根青草，微微嚼动，任由那淡淡的苦涩在嘴中弥漫开来……
14. 举起有些白皙的手掌，挡在眼前，目光透过手指缝隙，遥望着天空上那轮巨大的银月。
